...
// console.log(distance);
  ...
  if (distance > 0) {
    ...
    $('.image').parallax({imageSrc: '.../../images/banner.png'});
    $('.bg2').parallax({imageSrc: '.../../images/banner.png'});
    $('#one').parallax({imageSrc: '../../images/bg.jpeg'});
    clearInterval(x);
...
var options = {
  strings: ['Galie', '生日^200快樂！^800', '真既^200快樂! ^800',  '今日係2022年3月30日^800', '你名義上成為左^800大啲既人^300', '或者應該', '許個願先(^_^) ^1200', 
  '然之後我想講^800', '記得有一日你講我中二既時候^800', '話自己立體幾何滿分^800', '其實我第一時間感覺係^800',
  '覺得自己到底係唔係好自卑^800', '然後你投先又話自己可能好自卑^800', '咁我覺得我地幾似^800', '但我唔想你咁唸^800',
  '因為^300', '其實^800，', '其實^800，至2月以黎^300', '我就好似連埋左你咁^800', '會因為你病^800', '而夜晚唸到喊^1600', '亦會因為一條數一齊計度同一個錯既答案^800',
  '而係度笑。^800', '然後前日我搞到你唔開心^300', '我因為個腦一片空白^300', '淨係攬住個枕頭^1200', '其實我想講^300', '你話驚我覺得你煩^300', 
  '就^150', '係^150', '杞人憂天', '所以希望你係18歲既時候^800', '會小一個一個錯誤既觀念先^ ^ ^800', '最後最後，', 'Think about the future, not the past.', '😊^100000'],
  typeSpeed: 150,
